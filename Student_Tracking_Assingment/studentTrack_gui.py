...
def load_gui(self):
    ...
    self.btn_submit = tk.Button(self.master,width=12,height=2,text='Submit',command=lambda: studentTrack_func.addToList(self))
    self.btn_submit.grid(row=8,column=3,padx=(25,0),pady=(45,10),sticky=W)
    self.btn_delete = tk.Button(self.master,width=12,height=2,text='Delete',command=lambda: studentTrack_func.onDelete(self))
    self.btn_delete.grid(row=8,column=4,padx=(15,0),pady=(45,10),sticky=W)
